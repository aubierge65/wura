...
class CompanyController extends Controller
{
    ...
    public function blog(Request $request) {
        ...
        try {
           ...
           $userId = Auth::id();
            ...
            $query = Post::with('category', 'author:id,name,name')->where('author_type', User::class)->where('author_id', $userId)->withCount('comments');
   ...
   /**
     ...
     */
    public function blogStore(PostFormRequest $request)
    {
        try {
    ...
    public function blogUpdate(PostFormRequest $request, Post $post)
    {
        try {
     ...
     * @throws \Exception
     */
    public function blogDestroy(Post $post)
    {
