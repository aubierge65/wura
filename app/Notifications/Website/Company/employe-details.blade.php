                ...
                <div class="cadidate-details-sidebar">
                    ...
                    <div class="sidebar-widget">
                        <div class="row">
                            ...
                            @endif
                            @if ($companyDetails->age)
                            <div class="col-sm-6">
                                <div class="icon-box">
                                    <div class="icon-img">
                                    <x-svg.user-check-icon />
                                    </div>
                                    <h3 class="sub-title">{{ __('Moyenne d\'âge du personnel') }}</h3>
                                    <h2 class="title">
                                        {{ $companyDetails->age }} ans
                                    </h2>
                                </div>
                            </div>
                            @endif
                    ...
                    <div class="sidebar-widget">
                        ...
                        <div class="youtube-video">
                            <iframe width="100%" height="428" src="{{$user->company->video_url}}" title="{{$user->name}}" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                        </div>
                        @endif
                    </div>
