                                    ...
                                    <div class="dashboard-account-setting-item pb-0">
                                        <form action="{{ route('company.settingUpdateInformation') }}" method="POST">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-8">
                                                        <x-forms.label name="Lien youtube d'une vidéo décrivant l'entreprise" :required="false" class="pointer body-font-4 d-block text-gray-900 rt-mb-8" />
                                                    <div class="fromGroup  has-icon2">
                                                        <div class="form-control-icon">
                                                            <x-forms.input type="text" name="video"
                                                                value="{{ $user->company->video_url }}" placeholder="Lien youtube d'une vidéo décrivant l'entreprise" id="video" />
