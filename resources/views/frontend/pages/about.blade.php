    ...
    <div class="row">
        ...
        <div class="col-lg-6 col-md-6">
            <div class="image-container">
                <img src="{{ asset('frontend/assets/images/banner/about-banner-5.png') }}" alt="Image à droite" class="img-fluid" style="max-width: 100%; height: auto;">
            </div>
        </div>
    </div>
</div>
    ...
    <div class="row align-items-center">
        <div class="col-lg-4 col-md-6 mb-4">
            <div class="card text-center bg-primary-50">
                <div class="card-body">
                    <h5 class="card-title text-primary-500">{{ __('Avantage1') }}</h5>
                    <p class="card-text text-gray-400">{{ __('Av1_Desc') }}</p>
                </div>
            </div>
        </div>
        <div class="col-lg-4 col-md-6 mb-4">
            <div class="card text-center bg-primary-50">
                <div class="card-body">
                    <h5 class="card-title text-primary-500">{{ __('Avantage2') }}</h5>
                    <p class="card-text text-gray-400">{{ __('Avantage2_Desc') }}</p>
                </div>
            </div>
        </div>
        <div class="col-lg-4 col-md-6 mb-4">
            <div class="card text-center bg-primary-50">
                <div class="card-body">
                    <h5 class="card-title text-primary-500">{{ __('Avantage3') }}</h5>
                    <p class="card-text text-gray-400">{{ __('Avantage3_Desc') }}</p>
                </div>
            </div>
        </div>
        <div class="col-lg-4 col-md-6 mb-4">
            <div class="card text-center bg-primary-50">
                <div class="card-body">
                    <h5 class="card-title text-primary-500">{{ __('Avantage4') }}</h5>
                    <p class="card-text text-gray-400">{{ __('Avantage4_Desc') }}</p>
                </div>
            </div>
        </div>
        <div class="col-lg-4 col-md-6 mb-4">
            <div class="card text-center bg-primary-50">
                <div class="card-body">
                    <h5 class="card-title text-primary-500">{{ __('Avantage5') }}</h5>
                    <p class="card-text text-gray-400">{{ __('Avantage5_Desc') }}</p>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-4 col-md-6 mb-4">
            <div class="card text-center bg-primary-50">
                <div class="card-body">
                    <h5 class="card-title text-primary-500">{{ __('Avantage6') }}</h5>
                    <p class="card-text text-gray-400">{{ __('Avantage6_Desc') }}</p>
                </div>
            </div>
        </div>
        <div class="col-lg-4 col-md-6 mb-4">
            <div class="card text-center bg-primary-50">
                <div class="card-body">
                    <h5 class="card-title text-primary-500">{{ __('Avantage7') }}</h5>
                    <p class="card-text text-gray-400">{{ __('Avantage7_Desc') }}</p>
                </div>
            </div>
        </div>
        <div class="col-lg-4 col-md-6 mb-4">
            <div class="card text-center bg-primary-50">
                <div class="card-body">
                    <h5 class="card-title text-primary-500">{{ __('Avantage8') }}</h5>
                    <p class="card-text text-gray-400">{{ __('Avantage8_Desc') }}</p>
                </div>
            </div>
        </div>
        <div class="col-lg-4 col-md-6 mb-4">
            <div class="card text-center bg-primary-50">
                <div class="card-body">
                    <h5 class="card-title text-primary-500">{{ __('Avantage9') }}</h5>
                    <p class="card-text text-gray-400">{{ __('Avantage9_Desc') }}</p>
                </div>
            </div>
        </div>
    </div>
