                            ...
                            <tbody>
                                @forelse ($jobRoles as $key => $jobrole)
                                    <tr>
                                        <td class="vertical-middle">
                                            ...
                                            <div> 
                                                @foreach ($jobrole->translations as $translation)
                                                    ...
                                                    @else
                                                    @if (getLanguageByCodeInLookUp($translation->locale, $app_language) != '')
                                                        <span
                                        ...
                                        <td class="vertical-middle">
                                            <div>
                                                @foreach ($jobrole->category->translations as $translation)
                                                    @if (app()->getLocale() == $translation->locale)
                                                        <span class="d-block">
                                                            {{ $translation->name }}
                                                        </span>
                                    ...
                                    <div>
                                        ...
                                        <select name="category_id"
                                            ...
                                            @foreach ($job_categories as $category)
                                                <option {{ $jobRole->category_id == $category->id ? 'selected' : '' }}
