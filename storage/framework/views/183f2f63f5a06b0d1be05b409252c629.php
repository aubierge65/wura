...
} elseif ($_instance->childHasBeenRendered('hLSd7X3')) {
    $componentId = $_instance->getRenderedChildComponentId('hLSd7X3');
    $componentTag = $_instance->getRenderedChildComponentTagName('hLSd7X3');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('hLSd7X3');
} else {
    $response = \Livewire\Livewire::mount('country-state-city');
    $html = $response->html();
    $_instance->logRenderedChild('hLSd7X3', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                                            <?php endif; ?>
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/wura.africa/httpdocs/resources/views/frontend/pages/company/setting.blade.php ENDPATH**/ ?>