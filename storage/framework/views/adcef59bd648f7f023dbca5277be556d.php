                ...
                <div class="card">
                    <div class="card-body position-relative">
                        <div class="d-flex align-items-center mb-3">
                            <img class="img-fluid position-absolute" src="<?php echo e(asset('frontend/assets/images/rh/733.jpg')); ?>" alt="card image" style="width: 50px; height: 50px; object-fit: cover;">
        ...
        <div class="col-12 col-lg-4 mb-4">
            <div class="frontside">
                <div class="card last-three-cards">
                    <div class="card-body position-relative">
                        <div class="d-flex align-items-center mb-3">
                            <img class="img-fluid position-absolute" src="<?php echo e(asset('frontend/assets/images/rh/fuse.jpg')); ?>" alt="card image" style="width: 50px; height: 50px; object-fit: cover;">
        ...
        <div class="col-12 col-lg-4 mb-4 last-three-cards">
            <div class="frontside">
                <div class="card">
                    <div class="card-body position-relative">
                        <div class="d-flex align-items-center mb-3">
                            <img class="img-fluid position-absolute" src="<?php echo e(asset('frontend/assets/images/rh/66755.jpg')); ?>" alt="card image" style="width: 50px; height: 50px; object-fit: cover;">
        ...
        <div class="col-12 col-lg-4 offset-lg-4 mb-4">
            <div class="frontside">
                <div class="card" style="min-height:600px!important;">
                    <div class="card-body position-relative">
                        <div class="d-flex align-items-center mb-3">
                            <img class="img-fluid position-absolute" src="<?php echo e(asset('frontend/assets/images/rh/mesure.jpg')); ?>" alt="card image" style="width: 50px; height: 50px; object-fit: cover;">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/MEGATECH/wura1/resources/views/frontend/pages/servicespro.blade.php ENDPATH**/ ?>