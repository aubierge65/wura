...
<?php $__env->startSection('content'); ?>
    <div class="container-fluid">
        <div class="row">
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="d-flex flex-wrap justify-content-between">
                            <h3 class="card-title line-height-36"><?php echo e(__('profession_list')); ?>

                                (<?php echo e(count($professions)); ?>)</h3>
                        ...
                        <table class="table table-hover text-nowrap">
                            ...
                            <tbody>
                                <?php $__empty_1 = true; $__currentLoopData = $professions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $profession): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr>
                                        <td>
                                            <h5><?php echo e($profession->name); ?></h5>
                                            <div>
                                                <?php $__currentLoopData = $profession->translations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $translation): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <td>
                                            <?php if(userCan('professions.update')): ?>
                                                <a href="<?php echo e(route('profession.edit', $profession->id)); ?>"
                                                    class="btn bg-info"><i class="fas fa-edit"></i></a>
                                            <?php endif; ?>
                                            <?php if(userCan('professions.delete')): ?>
                                                <form action="<?php echo e(route('profession.destroy', $profession->id)); ?>"
            ...
            <div class="col-md-4">
                <?php if(!empty($prof) && userCan('professions.update')): ?>
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title line-height-36"><?php echo e(__('edit')); ?> <?php echo e(__('profession')); ?></h3>
                            <a href="<?php echo e(route('profession.index')); ?>"
                        ...
                        <div class="card-body">
                            <div class="pt-3 pb-4">
                                <form class="form-horizontal" action="<?php echo e(route('profession.update', $prof->id)); ?>"
                                    method="POST">
                                    <?php echo csrf_field(); ?>
...
<?php endif; ?>
                ...
                <?php endif; ?>
                <?php if(empty($prof) && userCan('professions.create')): ?>
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title line-height-36"><?php echo e(__('create')); ?> <?php echo e(__('profession')); ?></h3>
                        </div>
                        <div class="card-body">
                            <?php if(userCan('job_role.create')): ?>
                                <form class="form-horizontal" action="<?php echo e(route('profession.store')); ?>" method="POST">
                                    <?php echo csrf_field(); ?>
                                    <?php $__currentLoopData = $app_language; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $language): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php
                                            $label = __('name') . ' ' . getLanguageByCodeInLookUp($language->code,$app_language);
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/wura.africa/httpdocs/resources/views/backend/profession/index.blade.php ENDPATH**/ ?>