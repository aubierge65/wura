<?php $__env->startSection('title'); ?>
    <?php echo e(__('organization_types_list')); ?>
...
<?php $__env->startSection('content'); ?>
    <div class="container-fluid">
        <div class="row">
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="d-flex flex-wrap justify-content-between">
                            <h3 class="card-title line-height-36"><?php echo e(__('organization_types_list')); ?>

                                (<?php echo e($organizationTypes ? count($organizationTypes) : '0'); ?>)</h3>
                    ...
                    <div class="card-body table-responsive">
                        <table class="table table-hover text-nowrap">
                            ...
                            <tbody>
                                <?php $__empty_1 = true; $__currentLoopData = $organizationTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $organizationtype): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr>
                                        <td>
                                            <h5><?php echo e($organizationtype->name); ?></h5>
                                            <div>
                                                <?php $__currentLoopData = $organizationtype->translations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $translation): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <td>
                                            <a href="<?php echo e(route('organizationType.edit', $organizationtype->id)); ?>"
                                                class="btn bg-info">
                                                <i class="fas fa-edit"></i>
                                            </a>

                                            <form action="<?php echo e(route('organizationType.destroy', $organizationtype->id)); ?>"
            ...
            <div class="col-md-4">
                <?php if(!empty($organizationType)): ?>
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title line-height-36"><?php echo e(__('edit')); ?> <?php echo e(__('organization_type')); ?></h3>
                            <a href="<?php echo e(route('organizationType.index')); ?>"
                        ...
                        <div class="card-body">
                            <form class="form-horizontal"
                                action="<?php echo e(route('organizationType.update', $organizationType->id)); ?>" method="POST">
                                <?php echo csrf_field(); ?>
...
<?php endif; ?>
                ...
                <?php if(empty($organizationType)): ?>
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title line-height-36"><?php echo e(__('create')); ?> <?php echo e(__('organization_type')); ?></h3>
                        </div>
                        <div class="card-body">
                            <form class="form-horizontal" action="<?php echo e(route('organizationType.store')); ?>" method="POST">
                                <?php echo csrf_field(); ?>
                                <?php $__currentLoopData = $app_language; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $language): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php
                                        $label = __('name') . ' ' . getLanguageByCodeInLookUp($language->code,$app_language);
        ...
        <div class="modal fade" id="bulk_import_modal" tabindex="-1" role="dialog"
            ...
            <div class="modal-dialog modal-dialog-centered modal-md" role="document">
                <div class="modal-content">
                    ...
                    <form action="<?php echo e(route('admin.organization.type.bulk.import')); ?>" method="post"
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/wura.africa/httpdocs/resources/views/backend/organizationType/index.blade.php ENDPATH**/ ?>