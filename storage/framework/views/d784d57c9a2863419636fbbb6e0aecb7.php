...
} elseif ($_instance->childHasBeenRendered('VbIFsPB')) {
    $componentId = $_instance->getRenderedChildComponentId('VbIFsPB');
    $componentTag = $_instance->getRenderedChildComponentTagName('VbIFsPB');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('VbIFsPB');
} else {
    $response = \Livewire\Livewire::mount('country-state-city', ['row' => true]);
    $html = $response->html();
    $_instance->logRenderedChild('VbIFsPB', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                                            <?php $__errorArgs = ['location'];
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/wura.africa/httpdocs/resources/views/frontend/pages/company/postjob.blade.php ENDPATH**/ ?>