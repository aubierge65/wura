...
<?php endif; ?>
                                        <div class="position-relative">
                                            <input value="<?php echo e(old('min_salary')); ?>"
...
<?php endif; ?>
                                        <div class="position-relative">
                                            <input value="<?php echo e(old('max_salary')); ?>"
                                        ...
                                        <div class="fromGroup">
                                            <div class="form-control-icon date datepicker">
                                                <input value="<?php echo e(old('deadline')); ?>" name="deadline"
                                                    class="form-control !tw-ps-[] <?php $__errorArgs = ['deadline'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/MEGATECH/wura1/resources/views/frontend/pages/company/pay-per-job.blade.php ENDPATH**/ ?>