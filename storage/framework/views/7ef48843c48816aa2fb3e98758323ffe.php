...
<?php $component = App\View\Components\Forms\Label::resolve(['name' => 'profile_picture','class' => 'pointer body-font-4 d-block text-gray-900 rt-mb-8'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
    ...
    <div id="photo-uploadMode" class="<?php echo e($candidate->photo ? 'd-none' : ''); ?>">
    ...
    <div id="photo-oldMode" class="<?php echo e($candidate->photo ? '' : 'd-none'); ?>">
        <div class="profile-file-upload-content2">
            <img class="profile-file-upload-image" src="<?php echo e(asset($candidate->photo)); ?>"
                alt="your image" />
...
<?php /**PATH /var/www/vhosts/wura.africa/httpdocs/resources/views/components/website/candidate/photo-section.blade.php ENDPATH**/ ?>