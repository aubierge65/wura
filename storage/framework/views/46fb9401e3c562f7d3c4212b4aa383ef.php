<li>
    <div class="notification-icon relative pointer position-relative tw-text-white">
        ...
        <?php if(companyUnreadNotifications() > 0): ?>
                    ...
                    <?php if($notifications->count() > 0): ?>
                        <?php $__currentLoopData = $notifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $noti): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php if($noti->type == 'App\Notifications\Website\Candidate\ApplyJobNotification'): ?>
                                <li>
                                    <a onclick="readSingleNotification('<?php echo e(route('company.dashboard')); ?>', '<?php echo e($noti->id); ?>')"
                            ...
                            <?php endif; ?>
                            <?php if($noti->type == 'App\Notifications\Website\Company\PaymentMarkPaidNotification'): ?>
                                <li>
                            ...
                            <?php endif; ?>
                            <?php if($noti->type == 'App\Notifications\Website\Company\JobCreatedNotification' ||
                                $noti->type == 'App\Notifications\Website\Company\EditApproveNotification' ||
                            ...
                            <?php endif; ?>
                            <?php if($noti->type == 'App\Notifications\JobApprovalNotification'): ?>
                                <li>
                                    <a onclick="readSingleNotification('<?php echo e($noti->data['url']); ?>', '<?php echo e($noti->id); ?>')"
                                        href="javascript:void(0)" class="d-flex">
                                        <div class="notification-thumb">
                            ...
                            <?php endif; ?>
                            <?php if($noti->type == 'App\Notifications\SendProfileVerifiedNotification'): ?>
                                    <li>
                                        <a
                                            onclick="readSingleNotification('<?php echo e($noti->data['url']); ?>', '<?php echo e($noti->id); ?>')"
...
<?php /**PATH /var/www/vhosts/wura.africa/httpdocs/resources/views/components/website/company/notifications-component.blade.php ENDPATH**/ ?>