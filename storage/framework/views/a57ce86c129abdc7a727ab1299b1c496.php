...
<?php $__env->startSection('content'); ?>
    <div class="container-fluid">
        <div class="row">
                ...
                <div class="card">
                    <div class="card-header ">
                        <div class="d-flex justify-content-between">
                            <h3 class="card-title line-height-36"><?php echo e(__('job_type_list')); ?>

                                (<?php echo e(count($job_types)); ?>)</h3>
                        </div>
                    </div>
                        ...
                        <table class="table table-hover text-nowrap">
                            <thead>
                                <tr>
                                    ...
                                    <?php if(userCan('job_types.update') || userCan('job_types.delete')): ?>
                                        <th width="10%"><?php echo e(__('action')); ?></th>
                                    <?php endif; ?>
                                </tr>
                            </thead>
                            <tbody>
                                <?php $__empty_1 = true; $__currentLoopData = $job_types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr>
                                        <td>
                                        ...
                                        <td>
                                            <?php if(userCan('job_types.update')): ?>
                                                <a href="<?php echo e(route('jobType.edit', $data->id)); ?>" class="btn bg-info"><i
                                                        class="fas fa-edit"></i></a>
                                            <?php endif; ?>
                                            <?php if(userCan('job_types.delete')): ?>
                                                <form action="<?php echo e(route('jobType.destroy', $data->id)); ?>" method="POST"
                                                    class="d-inline">
            ...
            <div class="col-md-4">
                <?php if(!empty($job_type) && userCan('job_types.update')): ?>
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title line-height-36"><?php echo e(__('edit')); ?> <?php echo e(__('job_type')); ?></h3>
                            <a href="<?php echo e(route('jobType.index')); ?>"
                        ...
                        <div class="card-body">
                            <div class="pt-3 pb-4">
                                <form class="form-horizontal" action="<?php echo e(route('jobType.update', $job_type->id)); ?>"
                                    method="POST">
                                    <?php echo csrf_field(); ?>
...
<?php endif; ?>
                ...
                <?php endif; ?>
                <?php if(empty($job_type) && userCan('job_types.create')): ?>
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title line-height-36"><?php echo e(__('create')); ?> <?php echo e(__('job_type')); ?></h3>
                        </div>
                        <div class="card-body">
                            <?php if(userCan('job_role.create')): ?>
                                <form class="form-horizontal" action="<?php echo e(route('jobType.store')); ?>" method="POST">
                                    <?php echo csrf_field(); ?>
                                    <?php $__currentLoopData = $app_language; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $language): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php
                                            $label = __('name') . ' ' . getLanguageByCode($language->code);
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/wura.africa/httpdocs/resources/views/backend/job_type/index.blade.php ENDPATH**/ ?>