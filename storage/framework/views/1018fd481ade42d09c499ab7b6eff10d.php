...
<?php $__env->startSection('content'); ?>
    <div class="container-fluid">
        <div class="row">
                ...
                <div class="card">
                    <div class="card-header ">
                        <div class="d-flex flex-wrap justify-content-between">
                            <h3 class="card-title line-height-36"><?php echo e(__('tag_list')); ?>

                                (<?php echo e(count($tags)); ?>)</h3>
                        ...
                        <table class="table table-hover text-nowrap">
                            <thead>
                                <tr>
                                    ...
                                    <th>
                                        <?php echo e(__('show_popular_list')); ?>

                                        <span class="ml-2 btn m-0 p-0" data-toggle="tooltip" data-placement="right"
                                            title="<?php echo e(__('these_tags_will_show_the_user_as_a_popular_tag_suggestion_on_the_job_page')); ?>">
                                            <i class="text-danger text-lg fas fa-exclamation-circle"></i>
                                        </span>
                                    </th>
                                    <?php if(userCan('tags.update') || userCan('tags.delete')): ?>
                            ...
                            <tbody>
                                <?php $__empty_1 = true; $__currentLoopData = $tags; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr>
                                        <td>
                                            <h5><?php echo e(Str::ucfirst($item->name)); ?></h5>
                                            <div>
                                            ...
                                            <a href="#">
                                                <label class="switch ">
                                                    <input data-id="<?php echo e($item->id); ?>" type="checkbox"
                                                        ...
                                                        <?php echo e($item->show_popular_list == 1 ? 'checked' : ''); ?>>
                                                    <span class="slider round"></span>
                                                </label>
                                            </a>
                                        </td>
                                        <td>
                                            <?php if(userCan('tags.update')): ?>
                                                <a href="<?php echo e(route('tags.edit', $item->id)); ?>" class="btn bg-info"><i
                                                        class="fas fa-edit"></i></a>
                                            <?php endif; ?>
                                            <?php if(userCan('tags.delete')): ?>
                                                <form action="<?php echo e(route('tags.destroy', $item->id)); ?>" method="POST"
                                                    class="d-inline">
            ...
            <div class="col-md-4">
                <?php if(!empty($tag) && userCan('tags.update')): ?>
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title line-height-36"><?php echo e(__('edit')); ?> <?php echo e('tag'); ?></h3>
                        ...
                        <div class="card-body">
                            <div class="pt-3 pb-4">
                                <form class="form-horizontal" action="<?php echo e(route('tags.update', $tag->id)); ?>" method="POST">
                                    <?php echo csrf_field(); ?>
...
<?php endif; ?>
                ...
                <?php endif; ?>
                <?php if(empty($tag) && userCan('tags.create')): ?>
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title line-height-36"><?php echo e(__('create')); ?> <?php echo e('tag'); ?></h3>
                        </div>
                        <div class="card-body">
                            <?php if(userCan('tags.create')): ?>
                                <form class="form-horizontal" action="<?php echo e(route('tags.store')); ?>" method="POST">
                                    <?php echo csrf_field(); ?>
                                    <?php $__currentLoopData = $app_language; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $language): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php
                                            $label = __('name') . ' ' . getLanguageByCodeInLookUp($language->code,$app_language);
        ...
        <div class="modal fade" id="bulk_import_modal" tabindex="-1" role="dialog"
            ...
            <div class="modal-dialog modal-dialog-centered modal-md" role="document">
                <div class="modal-content">
                    ...
                    <form action="<?php echo e(route('admin.tags.bulk.import')); ?>" method="post" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
...
<?php $__env->startSection('script'); ?>
    <script>
        ...
        $('.tag-status').on('change', function() {
            ...
            var url = "<?php echo e(route('tags.status.change', ':id')); ?>";
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/wura.africa/httpdocs/resources/views/backend/tag/index.blade.php ENDPATH**/ ?>