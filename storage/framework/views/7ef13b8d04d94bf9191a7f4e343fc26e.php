...
} elseif ($_instance->childHasBeenRendered('VfA7G4l')) {
    $componentId = $_instance->getRenderedChildComponentId('VfA7G4l');
    $componentTag = $_instance->getRenderedChildComponentTagName('VfA7G4l');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('VfA7G4l');
} else {
    $response = \Livewire\Livewire::mount('country-state-city');
    $html = $response->html();
    $_instance->logRenderedChild('VfA7G4l', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                            <?php $__errorArgs = ['location'];
...
<?php /**PATH /var/www/vhosts/wura.africa/httpdocs/resources/views/components/website/company/account-progress/contact.blade.php ENDPATH**/ ?>