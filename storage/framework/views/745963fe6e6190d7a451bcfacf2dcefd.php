...
} elseif ($_instance->childHasBeenRendered('iU4UFHh')) {
    $componentId = $_instance->getRenderedChildComponentId('iU4UFHh');
    $componentTag = $_instance->getRenderedChildComponentTagName('iU4UFHh');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('iU4UFHh');
} else {
    $response = \Livewire\Livewire::mount('country-state-city');
    $html = $response->html();
    $_instance->logRenderedChild('iU4UFHh', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                                            <?php endif; ?>
