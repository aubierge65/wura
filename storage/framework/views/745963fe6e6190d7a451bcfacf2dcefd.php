...
} elseif ($_instance->childHasBeenRendered('Ifu3jLX')) {
    $componentId = $_instance->getRenderedChildComponentId('Ifu3jLX');
    $componentTag = $_instance->getRenderedChildComponentTagName('Ifu3jLX');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('Ifu3jLX');
} else {
    $response = \Livewire\Livewire::mount('country-state-city');
    $html = $response->html();
    $_instance->logRenderedChild('Ifu3jLX', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                                            <?php endif; ?>
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/MEGATECH/wura1/resources/views/frontend/pages/candidate/setting.blade.php ENDPATH**/ ?>