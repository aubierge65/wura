...
<?php endif; ?>
<script>
    var oldlat = <?php echo e($lat ? $lat : $setting->default_lat); ?>;
    var oldlng = <?php echo e($long ? $long : $setting->default_long); ?>;
...
<?php /**PATH /var/www/vhosts/wura.africa/httpdocs/Modules/Map/Resources/views/set-edit-leafletmap.blade.php ENDPATH**/ ?>