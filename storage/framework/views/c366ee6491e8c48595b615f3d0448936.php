...
} elseif ($_instance->childHasBeenRendered('zprjGW3')) {
    $componentId = $_instance->getRenderedChildComponentId('zprjGW3');
    $componentTag = $_instance->getRenderedChildComponentTagName('zprjGW3');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('zprjGW3');
} else {
    $response = \Livewire\Livewire::mount('country-state-city');
    $html = $response->html();
    $_instance->logRenderedChild('zprjGW3', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                                            <?php endif; ?>
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/MEGATECH/wura1/resources/views/frontend/pages/company/setting.blade.php ENDPATH**/ ?>