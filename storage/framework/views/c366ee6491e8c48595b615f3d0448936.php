...
} elseif ($_instance->childHasBeenRendered('HpU5GUx')) {
    $componentId = $_instance->getRenderedChildComponentId('HpU5GUx');
    $componentTag = $_instance->getRenderedChildComponentTagName('HpU5GUx');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('HpU5GUx');
} else {
    $response = \Livewire\Livewire::mount('country-state-city');
    $html = $response->html();
    $_instance->logRenderedChild('HpU5GUx', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                                            <?php endif; ?>
