...
} elseif ($_instance->childHasBeenRendered('wz6n3aK')) {
    $componentId = $_instance->getRenderedChildComponentId('wz6n3aK');
    $componentTag = $_instance->getRenderedChildComponentTagName('wz6n3aK');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('wz6n3aK');
} else {
    $response = \Livewire\Livewire::mount('country-state-city');
    $html = $response->html();
    $_instance->logRenderedChild('wz6n3aK', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                            <?php $__errorArgs = ['location'];
