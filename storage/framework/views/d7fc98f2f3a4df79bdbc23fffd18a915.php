...
} elseif ($_instance->childHasBeenRendered('S2hSJ0i')) {
    $componentId = $_instance->getRenderedChildComponentId('S2hSJ0i');
    $componentTag = $_instance->getRenderedChildComponentTagName('S2hSJ0i');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('S2hSJ0i');
} else {
    $response = \Livewire\Livewire::mount('country-state-city');
    $html = $response->html();
    $_instance->logRenderedChild('S2hSJ0i', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                            <?php $__errorArgs = ['location'];
