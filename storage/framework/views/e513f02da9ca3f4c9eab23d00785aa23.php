                                            ...
                                            <div>
                                                <?php if($job->salary_mode == 'range'): ?>
                                                    <h3><?php echo e(getFormattedNumber($job->min_salary)); ?> -
                                                        <?php echo e(getFormattedNumber($job->max_salary)); ?> <?php echo e(currentCurrencyCode()); ?>
                                                ...
                                                <div class="custom-control custom-radio custom-control-inline">
                                                    <form action="<?php echo e(route('admin.job.status.change', $job->id)); ?>"
                                                        ...
                                                        <input
                                                            ...
                                                            value="pending" <?php echo e($job->status == 'pending' ? 'checked' : ''); ?>>
                                                ...
                                                <div class="custom-control custom-radio custom-control-inline">
                                                    <form action="<?php echo e(route('admin.job.status.change', $job->id)); ?>"
                                                        ...
                                                        <input disabled
                                                            ...
                                                            name="status" class="plan_type_selection custom-control-input"
                                                            value="expired" <?php echo e($job->status == 'expired' ? 'checked' : ''); ?>>
                                                        <label
...
<?php endif; ?>
                                                ...
                                                <div>
                                                    ...
                                                    <a href="<?php echo e($job->company->website); ?>"><?php echo e($job->company->website); ?></a>
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/wura.africa/httpdocs/resources/views/backend/Job/show.blade.php ENDPATH**/ ?>