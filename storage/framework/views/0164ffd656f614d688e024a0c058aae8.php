...
<?php foreach($attributes->onlyProps(['countries', 'categories', 'jobRoles', 'min_salary', 'max_salary', 'experiences', 'educations', 'jobTypes', 'currentCurrency']) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
} ?>
<?php $attributes = $attributes->exceptProps(['countries', 'categories', 'jobRoles', 'min_salary', 'max_salary', 'experiences', 'educations', 'jobTypes', 'currentCurrency']); ?>
<?php foreach (array_filter((['countries', 'categories', 'jobRoles', 'min_salary', 'max_salary', 'experiences', 'educations', 'jobTypes', 'currentCurrency']), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
} ?>
            ...
            <div class="col-lg-7 tw-p-3">
                <div class="tw-flex tw-flex-wrap md:tw-flex-nowrap tw-gap-3">
                    <div class="tw-w-full tw-relative fromGroup">
                        <?php if($map == 'map-box'): ?>
                            <input type="hidden" name="location" id="insertlocation" value="<?php echo e(request('location')); ?>">
...
<?php if (isset($component)) { $__componentOriginal59cdf808acc2783cd8796bfa2a5c0fd2 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal59cdf808acc2783cd8796bfa2a5c0fd2 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.website.modal.filters-modal','data' => ['jobTypes' => $jobTypes,'categories' => $categories,'maxSalary' => $maxSalary,'currentCurrency' => $currentCurrency]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('website.modal.filters-modal'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(Illuminate\View\AnonymousComponent::class))->getConstructor()): ?>
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['job-types' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($jobTypes),'categories' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($categories),'max-salary' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($maxSalary),'currentCurrency' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($currentCurrency)]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal59cdf808acc2783cd8796bfa2a5c0fd2)): ?>
<?php $attributes = $__attributesOriginal59cdf808acc2783cd8796bfa2a5c0fd2; ?>
<?php unset($__attributesOriginal59cdf808acc2783cd8796bfa2a5c0fd2); ?>
<?php endif; ?>
<?php if (isset($__componentOriginal59cdf808acc2783cd8796bfa2a5c0fd2)): ?>
<?php $component = $__componentOriginal59cdf808acc2783cd8796bfa2a5c0fd2; ?>
<?php unset($__componentOriginal59cdf808acc2783cd8796bfa2a5c0fd2); ?>
<?php endif; ?>
...
<?php endif; ?>
    <?php endif; ?>
    <link rel="stylesheet" href="<?php echo e(asset('frontend/plugins/mapbox/mapbox-gl.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('frontend/plugins/mapbox/style.css')); ?>">
    <style>
        .ll-findjob-banner {
            border-radius: 8px;
...
<?php endif; ?>
    <?php elseif($map == 'map-box'): ?>
        <script src="<?php echo e(asset('frontend/plugins/mapbox/mapbox-gl.js')); ?>"></script>
        <script src="<?php echo e(asset('frontend/plugins/mapbox/mapbox-gl-geocoder.min.js')); ?>"></script>

        <script>
            var country_code = '<?php echo e(current_country_code()); ?>'

            mapboxgl.accessToken = "<?php echo e($setting->map_box_key); ?>";
        ...
        <script>
            ...
            var oldLocation = "<?php echo $oldLocation; ?>";
            if (oldLocation) {
    ...
    <?php endif; ?>
<?php $__env->stopPush(); ?>
<?php /**PATH /var/www/vhosts/wura.africa/httpdocs/resources/views/components/website/job/job-filtering.blade.php ENDPATH**/ ?>