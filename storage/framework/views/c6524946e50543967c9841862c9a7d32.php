        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-7 rt-mb-lg-30">
                    ...
                    <div class="body-font-1 ft-wt-5 rt-mb-20"><?php echo e(__('company_vision')); ?></div>
                    <div class="body-font-3 text-gray-500" style="overflow: hidden;">
                        <?php echo $user->company->vision; ?>
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/MEGATECH/wura1/resources/views/frontend/pages/employe-details.blade.php ENDPATH**/ ?>