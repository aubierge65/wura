        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-9 col-md-8">
                    <div class="mx-646">
                        <span
                            class="body-font-3 ft-wt-5 text-primary-500 rt-mb-15 d-inline-block"><?php echo e(__('who_we_are')); ?></span>
                        <h2 class="lg:tw-mb-10 tw-mb-6 <?php echo e($setting->nav_color ? '' : $setting->nav_color); ?>">
                            <?php echo e(__('we_are_highly_skilled_and_professionals_team')); ?></h2>
                            ...
                            <div class="card-body">
                                <div class="rt-single-icon-box">
                                    ...
                                    <div class="iconbox-content">
                                        <div class="f-size-24 ft-wt-5 rt-mb-12"><span class="counter"><?php echo e(livejob()); ?>
                            ...
                            <div class="card jobcardStyle1 counterbox2">
                                <div class="card-body">
                                    <div class="rt-single-icon-box">
                                        ...
                                        <div class="iconbox-content">
                                            <div class="f-size-24 ft-wt-5 rt-mb-12"><span
                                                    class="counter"><?php echo e($candidates); ?></span></div>
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/wura.africa/httpdocs/resources/views/frontend/pages/about.blade.php ENDPATH**/ ?>