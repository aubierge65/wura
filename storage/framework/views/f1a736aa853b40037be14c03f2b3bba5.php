<?php $__env->startSection('title'); ?>
    <?php echo e(__('plan')); ?> (<?php echo e($plan->label); ?>)
    ...
    <section class="section benefits bgcolor--gray-10 mt-5 pt-5">
        <div class="container">
            <div class="row mt-5 pt-5">
                <h4 class="text-info"><?php echo e(__('total_amount_to_pay')); ?>: <?php echo e(currencyPosition($plan->price, true)); ?></h4>
            </div>
            <div class="row py-5">
                ...
                <?php if(config('paypal.active') ||
                    ...
                    <?php endif; ?>
                    <?php if(config('templatecookie.Iyzipay_api_key') && config('templatecookie.Iyzipay_api_secret') && config('templatecookie.Iyzipay_base_url')): ?>
                    <div class="col-4 my-2">
                        <div class="card jobcardStyle1">
                            <div class="card-body">
                                <div class="rt-single-icon-box">
...
<?php endif; ?>
                        <h5 class="mt-4"><?php echo e(__('no_payment_method_available_here')); ?></h5>
                    </div>
                <?php endif; ?>
            </div>
            <?php if($manual_payments && count($manual_payments)): ?>
                <div class="row mb-5">
        ...
        <?php if(config('templatecookie.flw_public_key') && config('templatecookie.flw_secret') && config('templatecookie.flw_secret_hash') && config('templatecookie.flw_active')): ?>
        ...
        <form method="post" action="<?php echo e(route('sslc.payment')); ?>" id="sslc-form">
            <?php echo csrf_field(); ?>
            <input type="hidden" value="<?php echo e(session('ssl_amount')); ?>" name="amount" id="total_amount" />
            <input id="ssl_plan_id" type="hidden" name="plan_id" value="<?php echo e($plan->id); ?>">
        </form>

        

        <form action="<?php echo e(route('iyzipay.post')); ?>" method="POST" class="d-none" id="iyzipay-form">
            <?php echo csrf_field(); ?>
        </form>
...
<?php $__env->startSection('script'); ?>
    <?php if(config('templatecookie.midtrans_active') &&
        ...
        <?php if(config('templatecookie.midtrans_live_mode')): ?>
            <script src="https://app.midtrans.com/snap/snap.js" data-client-key="<?php echo e(config('templatecookie.midtrans_client_key')); ?>">
            </script>
        <?php else: ?>
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/wura.africa/httpdocs/resources/views/frontend/pages/plan-details.blade.php ENDPATH**/ ?>