...
} elseif ($_instance->childHasBeenRendered('qkd4DTK')) {
    $componentId = $_instance->getRenderedChildComponentId('qkd4DTK');
    $componentTag = $_instance->getRenderedChildComponentTagName('qkd4DTK');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('qkd4DTK');
} else {
    $response = \Livewire\Livewire::mount('country-state-city');
    $html = $response->html();
    $_instance->logRenderedChild('qkd4DTK', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                                            <?php endif; ?>
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/wura.africa/httpdocs/resources/views/frontend/pages/candidate/setting.blade.php ENDPATH**/ ?>