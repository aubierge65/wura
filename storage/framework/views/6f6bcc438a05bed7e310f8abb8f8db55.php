...
} elseif ($_instance->childHasBeenRendered('vZlBOWG')) {
    $componentId = $_instance->getRenderedChildComponentId('vZlBOWG');
    $componentTag = $_instance->getRenderedChildComponentTagName('vZlBOWG');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('vZlBOWG');
} else {
    $response = \Livewire\Livewire::mount('country-state-city', ['row' => true]);
    $html = $response->html();
    $_instance->logRenderedChild('vZlBOWG', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                                            <?php $__errorArgs = ['location'];
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/wura.africa/httpdocs/resources/views/frontend/pages/company/editjob.blade.php ENDPATH**/ ?>