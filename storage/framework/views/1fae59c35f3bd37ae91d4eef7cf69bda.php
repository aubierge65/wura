<?php $__env->startSection('title'); ?>
    <?php echo e(__('salary_types_list')); ?>
...
<?php $__env->startSection('content'); ?>
    <div class="container-fluid">
        <div class="row">
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="d-flex flex-wrap justify-content-between">
                            <h3 class="card-title line-height-36"><?php echo e(__('salary_types_list')); ?>

                                (<?php echo e($salaryTypes ? count($salaryTypes) : '0'); ?>)</h3>
                    ...
                    <div class="card-body table-responsive">
                        <table class="table table-hover text-nowrap">
                            ...
                            <tbody>
                                <?php $__empty_1 = true; $__currentLoopData = $salaryTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $salaryType): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr>
                                        <td>
                                            <h5><?php echo e($salaryType->name); ?></h5>
                                            <div>
                                                <?php $__currentLoopData = $salaryType->translations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $translation): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <td>
                                            <a href="<?php echo e(route('salaryType.edit', $salaryType->id)); ?>"
                                                class="btn bg-info">
                                                <i class="fas fa-edit"></i>
                                            </a>

                                            <form action="<?php echo e(route('salaryType.destroy', $salaryType->id)); ?>"
            ...
            <div class="col-md-4">
                <?php if(!empty($salaryType_id)): ?>
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title line-height-36"><?php echo e(__('edit')); ?> <?php echo e(__('salary_type')); ?></h3>
                            <a href="<?php echo e(route('salaryType.index')); ?>"
                        ...
                        <div class="card-body">
                            <form class="form-horizontal"
                                action="<?php echo e(route('salaryType.update', $salaryType_id->id)); ?>" method="POST">
                                <?php echo csrf_field(); ?>
                                ...
                                <?php $__currentLoopData = $app_language; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $language): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php
                                        ...
                                        $data = $salaryType_id->translations->where('locale', $language->code)->first();
...
<?php endif; ?>
                ...
                <?php if(empty($salaryType_id)): ?>
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title line-height-36"><?php echo e(__('create')); ?> <?php echo e(__('salary_type')); ?></h3>
                        </div>
                        <div class="card-body">
                            <form class="form-horizontal" action="<?php echo e(route('salaryType.store')); ?>" method="POST">
                                <?php echo csrf_field(); ?>
                                <?php $__currentLoopData = $app_language; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $language): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php
                                        $label = __('name') . ' ' . getLanguageByCodeInLookUp($language->code,$app_language);
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/wura.africa/httpdocs/resources/views/backend/salaryType/index.blade.php ENDPATH**/ ?>