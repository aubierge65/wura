...
} elseif ($_instance->childHasBeenRendered('Gk3Cbgl')) {
    $componentId = $_instance->getRenderedChildComponentId('Gk3Cbgl');
    $componentTag = $_instance->getRenderedChildComponentTagName('Gk3Cbgl');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('Gk3Cbgl');
} else {
    $response = \Livewire\Livewire::mount('country-state-city', ['row' => true]);
    $html = $response->html();
    $_instance->logRenderedChild('Gk3Cbgl', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                                            <?php $__errorArgs = ['location'];
