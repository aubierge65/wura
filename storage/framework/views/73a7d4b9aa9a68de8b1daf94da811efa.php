...
} elseif ($_instance->childHasBeenRendered('xDRacoR')) {
    $componentId = $_instance->getRenderedChildComponentId('xDRacoR');
    $componentTag = $_instance->getRenderedChildComponentTagName('xDRacoR');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('xDRacoR');
} else {
    $response = \Livewire\Livewire::mount('country-state-city', ['row' => true]);
    $html = $response->html();
    $_instance->logRenderedChild('xDRacoR', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                                            <?php $__errorArgs = ['location'];
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/MEGATECH/wura1/resources/views/frontend/pages/company/postjob.blade.php ENDPATH**/ ?>