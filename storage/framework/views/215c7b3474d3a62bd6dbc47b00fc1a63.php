...
<?php endif; ?>
                <div class="col-lg-9">
                    <div class="dashboard-right">
                        ...
                        <form action="<?php echo e(route('company.job.update', $job->slug)); ?>" method="POST" class="rt-from">
                            <?php echo csrf_field(); ?>
...
<?php endif; ?>
                                        <input value="<?php echo e($job->title); ?>" name="title"
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-lg-4 rt-mb-20 col-md-4">
                                        <?php if (isset($component)) { $__componentOriginal89b295b0763c93abe0143426334eb5d6 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal89b295b0763c93abe0143426334eb5d6 = $attributes; } ?>
<?php $component = App\View\Components\Forms\Label::resolve(['name' => 'job_category','required' => true] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('forms.label'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(App\View\Components\Forms\Label::class))->getConstructor()): ?>
...
<?php endif; ?>
                                        <select
                                            class="select2-taggable  category_id554 form-control <?php $__errorArgs = ['category_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                            ...
                                            <?php $__currentLoopData = $jobCategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option <?php echo e($job->category_id == $category->id ? 'selected' : ''); ?>
...
<?php endif; ?>
                                        <select
                                            class=" select2-taggable form-control <?php $__errorArgs = ['role_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                            ...
                                            <?php $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option <?php echo e($job->role_id == $role->id ? 'selected' : ''); ?>
...
<?php endif; ?>
                                        <div class="position-relative">
                                            <input value="<?php echo e(old('custom_salary', $job->custom_salary)); ?>"
                                                name="custom_salary"
...
<?php endif; ?>
                                        <div class="position-relative">
                                            <input step="0.01" value="<?php echo e($job->min_salary); ?>"
...
<?php endif; ?>
                                        <div class="position-relative">
                                            <input step="0.01" value="<?php echo e($job->max_salary); ?>"
...
unset($__errorArgs, $__bag); ?> "
                                            ...
                                            <?php $__currentLoopData = $salary_types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option <?php echo e($job->salary_type_id == $type->id ? 'selected' : ''); ?>
...
unset($__errorArgs, $__bag); ?> "
                                            ...
                                            <?php $__currentLoopData = $educations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $education): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option <?php echo e($job->education_id == $education->id ? 'selected' : ''); ?>
...
unset($__errorArgs, $__bag); ?> "
                                            ...
                                            <?php $__currentLoopData = $experiences; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $experience): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option <?php echo e($job->experience_id == $experience->id ? 'selected' : ''); ?>
...
unset($__errorArgs, $__bag); ?> "
                                            ...
                                            <?php $__currentLoopData = $job_types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $job_type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option <?php echo e($job->job_type_id == $job_type->id ? 'selected' : ''); ?>
...
<?php unset($__componentOriginal89b295b0763c93abe0143426334eb5d6); ?>
<?php endif; ?>
                                        <input value="<?php echo e($job->vacancies); ?>" name="vacancies" type="text"
...
<?php endif; ?>
                                        <div class="fromGroup">
                                            <div class="form-control-icon date datepicker">
                                                <input value="<?php echo e(date('d-m-Y', strtotime($job->deadline))); ?>"
                                                    name="deadline"
                                                    class="form-control !tw-ps-[55px] <?php $__errorArgs = ['deadline'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="row form-group">
                                    <div class="col-md-6">
                                        <?php if (isset($component)) { $__componentOriginal89b295b0763c93abe0143426334eb5d6 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal89b295b0763c93abe0143426334eb5d6 = $attributes; } ?>
<?php $component = App\View\Components\Forms\Label::resolve(['name' => 'job_mode','for' => 'job_mode_id','required' => true] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('forms.label'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(App\View\Components\Forms\Label::class))->getConstructor()): ?>
...
<?php endif; ?>
                                        <select id="job_mode_id" name="job_mode_id"
                                            class="form-control select2bs4 <?php $__errorArgs = ['job_mode_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                            required>
                                            <option value=""> <?php echo e(__('job_mode')); ?></option>
                                            <?php $__currentLoopData = $modes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mode): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option <?php echo e($mode->id == $job->job_mode_id ? 'selected' : ''); ?>

                                                    value="<?php echo e($mode->id); ?>"><?php echo e($mode->name); ?>

                                                </option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
                                        <?php $__errorArgs = ['job_mode_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-md-6">
                                        <?php if (isset($component)) { $__componentOriginal89b295b0763c93abe0143426334eb5d6 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal89b295b0763c93abe0143426334eb5d6 = $attributes; } ?>
<?php $component = App\View\Components\Forms\Label::resolve(['name' => 'job_contracts','for' => 'job_contracts_id','required' => true] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('forms.label'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(App\View\Components\Forms\Label::class))->getConstructor()): ?>
...
<?php endif; ?>
                                        <select id="job_contracts_id" name="job_contracts_id"
                                            class="form-control select2bs4 <?php $__errorArgs = ['job_contracts_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                            required>
                                            <option value=""> <?php echo e(__('job_contracts')); ?></option>
                                            <?php $__currentLoopData = $contrats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $contrat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option <?php echo e($contrat->id == $job->job_contracts_id ? 'selected' : ''); ?>

                                                    value="<?php echo e($contrat->id); ?>"><?php echo e($contrat->name); ?>

                                                </option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
                                        <?php $__errorArgs = ['job_contracts_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div id="langues-container">
                                    ...
                                    <?php $__currentLoopData = $job->languages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $langueChoisi): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="langues-div">
                                            <button type="button" class="btn btn-danger remove-langue"
                                                style="margin-top: 10px;">Supprimer</button>
...
unset($__errorArgs, $__bag); ?>"
                                                        ...
                                                        <option value=""> <?php echo e(__('langue')); ?></option>
                                                        <?php $__currentLoopData = $langues; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $langue): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <option
                                                                <?php echo e($langue->id == $langueChoisi->id ? 'selected' : ''); ?>

                                                                value="<?php echo e($langue->id); ?>"><?php echo e($langue->name); ?>
...
unset($__errorArgs, $__bag); ?>"
                                                        ...
                                                        <?php $__currentLoopData = $levels; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $level): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <option
                                                                <?php echo e($level->id == $langueChoisi->pivot->level_id ? 'selected' : ''); ?>

                                                                value="<?php echo e($level->id); ?>"><?php echo e($level->name); ?>
...
<?php endif; ?>
                                                    ...
                                                    <div class="<?php echo e($map == 'leaflet' ? '' : 'd-none'); ?>">
                                                        <input type="text" autocomplete="off" id="leaflet_search"
                                                            ...
                                                            value="<?php echo e($job->exact_location ? $job->exact_location : $job->full_address); ?>" />
                                                        <br>
                                                ...
                                                <div class="col-12 mt-4 custom-checkbox-wrap">
                                                    <label class="main tw-text-sm"
                                                        ...
                                                        <input type="checkbox" name="is_remote" id="remoteWork"
                                                            value="1" <?php echo e($job->is_remote ? 'checked' : ''); ?>>
...
} elseif ($_instance->childHasBeenRendered('zAv247U')) {
    $componentId = $_instance->getRenderedChildComponentId('zAv247U');
    $componentTag = $_instance->getRenderedChildComponentTagName('zAv247U');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('zAv247U');
} else {
    $response = \Livewire\Livewire::mount('country-state-city', ['row' => true]);
    $html = $response->html();
    $_instance->logRenderedChild('zAv247U', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                                            <?php $__errorArgs = ['location'];
                                ...
                                <div class="benefits-tags">
                                    <?php $__currentLoopData = $benefits; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $benefit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <label for="benefit_<?php echo e($benefit->id); ?>">
                                            ...
                                            <?php echo e($job_benefit->id == $benefit->id ? 'checked' : ''); ?> <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="post-job-item rt-mb-32">
                                <h4 class="f-size-18 ft-wt-5 tw-mb-3 lh-1"><?php echo e(__('job_description')); ?></h4>
                                <div class="col-md-12">
                                    <textarea id="image_ckeditor" class="form-control <?php $__errorArgs = ['description'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="description"><?php echo e($job->description); ?></textarea>
                                            ...
                                            <div class="col-lg-12">
                                                <div x-show="isAddingNewQuestion" class="tw-flex justify-content-between">
                                                    ...
                                                    <a x-show="isAddingNewQuestion" href="#"
                                                        @click.prevent="isAddingNewQuestion = false"><?php echo e(__('choose_from_existing_question')); ?></a>
                                                </div>
                                    ...
                                    <div class="applied-job-on">
                                        <div class="row">
                                            ...
                                            <div id="applied_on_app"
                                                class="radio-check col-lg-4 d-flex <?php echo e($job->apply_on === 'app' ? 'checked' : ''); ?>"
                                                onclick="RadioChecked('app')">
                                                <input type="radio" <?php echo e($job->apply_on === 'app' ? 'checked' : ''); ?>
                                            ...
                                            <div id="applied_on_custom_url"
                                                class="radio-check col-lg-4 d-flex <?php echo e($job->apply_on === 'custom_url' ? 'checked' : ''); ?>"
                                                onclick="RadioChecked('custom_url')">
                                                <input type="radio"
                                                    <?php echo e($job->apply_on === 'custom_url' ? 'checked' : ''); ?>
                                            ...
                                            <div id="applied_on_email"
                                                class="radio-check col-lg-4 d-flex <?php echo e($job->apply_on === 'email' ? 'checked' : ''); ?>"
                                                onclick="RadioChecked('email')">
                                                <input type="radio" <?php echo e($job->apply_on === 'email' ? 'checked' : ''); ?>
...
<?php endif; ?>
                                                <div class="fromGroup has-icon2">
                                                    <div class="form-control-icon">
                                                        <input value="<?php echo e($job->apply_url); ?>" name="apply_url"
...
<?php endif; ?>
                                                <div class="fromGroup has-icon2">
                                                    <div class="form-control-icon">
                                                        <input value="<?php echo e($job->apply_email); ?>" name="apply_email"
...
<?php $__env->startSection('frontend_scripts'); ?>
    ...
    <script>
        function appQuestion() {
            return {
                ...
                selectedQuestions: <?php echo json_encode($job->questions, 15, 512) ?>,
                selectedQuestionsIds: <?php echo json_encode($job->questions->pluck('id')->toArray(), 15, 512) ?>,
                newQuestion: '',
    ...
    <?php if(app()->getLocale() == 'ar'): ?>
        <script src="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-datepicker/1.9.0/locales/bootstrap-datepicker.ar.min.js
                            "></script>
    <?php endif; ?>
    <?php echo $__env->make('map::set-edit-leafletmap', ['lat' => $job->lat, 'long' => $job->long], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <script>
        var start_day = '<?php echo e($start_day); ?>'
        var end_day = '<?php echo e($end_day); ?>'
    ...
    <?php echo $__env->make('map::set-edit-googlemap', ['job' => $job], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\wura\resources\views/frontend/pages/company/editjob.blade.php ENDPATH**/ ?>