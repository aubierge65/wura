                ...
                <div class="col-lg-9">
                    <div class="dashboard-right tw-ps-0 lg:tw-ps-5">
                        <div class="dashboard-right-header">
                            <div class="left-text">
                                <h5><?php echo e(__('hello')); ?>, <?php echo e(ucfirst(auth()->user()->name)); ?></h5>
                                <p class="m-0"><?php echo e(__('here_is_your_daily_activities_career_opportunities')); ?>
                        ...
                        <div class="row">
                                ...
                                <div class="single-feature-box">
                                    <div class="single-feature-data">
                                        <h6 class="tw-text-[#18191C] tw-text-2xl tw-font-semibold"
                                            class="tw-text-[#18191C] tw-text-2xl tw-font-semibold"><?php echo e($openJobCount); ?></h6>
                                        <p><?php echo e(__('open_job')); ?></p>
                                    </div>
                            ...
                            <div class="col-xl-4 col-lg-6 col-md-6">
                                <div class="single-feature-box">
                                    <div class="single-feature-data">
                                        <h6 class="tw-text-[#18191C] tw-text-2xl tw-font-semibold"
                                            class="tw-text-[#18191C] tw-text-2xl tw-font-semibold"><?php echo e($savedCandidates); ?>

                                        </h6>
                                        <p><?php echo e(__('saved_candidate')); ?></p>
                                    </div>
                                    <div class="single-feature-icon">
                            ...
                            <div class="col-xl-4 col-lg-6 col-md-6">
                                <div class="single-feature-box bg-danger-50">
                                    <div class="single-feature-data">
                                        <h6 class="tw-text-[#18191C] tw-text-2xl tw-font-semibold"
                                            class="tw-text-[#18191C] tw-text-2xl tw-font-semibold"><?php echo e($pendingJobCount); ?>

                                        </h6>
                                        <p><?php echo e(__('pending_jobs')); ?></p>
                                    </div>
                                    <div class="single-feature-icon">
                                        ...
                                        <div class="col-xl-3 col-lg-6 col-md-6">
                                            <div class="">
                                                <div
                                                    ...
                                                    <span><?php echo e($userplan->job_limit); ?></span>
                                                </div>
                                                <p class="tw-text-sm tw-text-[#474C54] tw-mt-1 tw-mb-0">
                                                    <?php echo e(__('active_jobs')); ?></p>
                                            </div>
                                        </div>
                                        <div class="col-xl-3 col-lg-6 col-md-6">
                                            <div class="">
                                                <div
                                                    ...
                                                    <span><?php echo e($userplan->highlight_job_limit); ?></span>
                                                </div>
                                                <p class="tw-text-sm tw-text-[#474C54] tw-mt-1 tw-mb-0">
                                                    <?php echo e(__('highlight_jobs')); ?>
                                        ...
                                        <div class="col-xl-3 col-lg-6 col-md-6">
                                            <div class="">
                                                <div
                                                    ...
                                                    <span><?php echo e($userplan->featured_job_limit); ?></span>
                                                </div>
                                                <p class="tw-text-sm tw-text-[#474C54] tw-mt-1 tw-mb-0">
                                                    <?php echo e(__('featured_jobs')); ?>
                                        ...
                                        <div class="col-xl-3 col-lg-6 col-md-6">
                                            <div class="">
                                                <div
                                                    ...
                                                    <span><?php echo e($userplan->candidate_cv_view_limitation == 'limited' ? $userplan->candidate_cv_view_limit : __('unlimited')); ?></span>
                                                </div>
                                                <p class="tw-text-sm tw-text-[#474C54] tw-mt-1 tw-mb-0">
                                                    <?php echo e(__('profile_view')); ?>

                                                </p>
                                            </div>
                                        </div>
                                        <div class="tw-mt-5">
                                            <a href="<?php echo e(route('website.plan')); ?>"
                        ...
                        <div class="recently-applied-wrap tw-mt-3 d-flex justify-content-between align-items-center rt-mb-15">
                            <h3 class="f-size-16"><?php echo e(__('recent_jobs')); ?></h3>
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/wura.africa/httpdocs/resources/views/frontend/pages/company/dashboard.blade.php ENDPATH**/ ?>