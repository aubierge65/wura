                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title line-height-36"><?php echo e(__('create')); ?> <?php echo e(__('plan')); ?></h3>
                        ...
                        <div class="card-body">
                            <div class="row justify-content-center">
                                <div class="col-md-8">
                                    <form action="<?php echo e(route('module.plan.store')); ?>" method="POST">
                                        <?php echo csrf_field(); ?>
                                        <div class="row">
                                            <div class="col-md-6">
...
unset($__errorArgs, $__bag); ?>"
                                                        placeholder="<?php echo e(__('10')); ?><?php echo e(defaultCurrencySymbol()); ?>">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" id="job_limit" name="job_limit"
                                                        value="<?php echo e(old('job_limit')); ?>"
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" id="featured_job_limit" name="featured_job_limit"
                                                        value="<?php echo e(old('featured_job_limit')); ?>"
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" id="highlight_job_limit"
                                                        name="highlight_job_limit" value="<?php echo e(old('highlight_job_limit')); ?>"
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="form-label" for="candidate_profile_view_limitation">
                                                        <?php echo e(__('candidate_profile_view_limitation')); ?> <small
                                                            class="text-danger">*</small>
                                                    </label> <br>
                                                    <div class="custom-control custom-radio custom-control-inline">
                                                        <input
                                                            <?php echo e(!old('candidate_cv_view_limitation') || old('candidate_cv_view_limitation') == 'limited' ? 'checked' : ''); ?>
                                                        ...
                                                        <label class="custom-control-label"
                                                            for="limited_profile_view"><?php echo e(__('limited')); ?></label>
                                                    </div>
                                                    <div class="custom-control custom-radio custom-control-inline">
                                                        <input
                                                            <?php echo e(old('candidate_cv_view_limitation') == 'unlimited' ? 'checked' : ''); ?>
                                            ...
                                            <div class="col-md-6" id="candidate_profile_view_count_field">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" id="candidate_cv_preview_limit"
                                                        ...
                                                        value="<?php echo e(old('candidate_cv_view_limit')); ?>"
...
unset($__errorArgs, $__bag); ?>"
                                                        placeholder="<?php echo e(__('enter')); ?> <?php echo e(__('candidate_cv_preview_limit')); ?>"
                                                        min="0">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="custom-control custom-radio custom-control-inline">
                                                        <input type="radio" id="show_frontend_yes" name="frontend_show"
                                                            ...
                                                            value="1" checked>
                                                        <label class="custom-control-label"
                                                            for="show_frontend_yes"><?php echo e(__('yes')); ?></label>
                                                    </div>
                                                    <div class="custom-control custom-radio custom-control-inline">
...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="form-label" for="frontend_show">
                                                        <?php echo e(__('mark_profile_verify')); ?> <small
                                                            class="text-danger">*</small>
                                                    </label> <br>
                                                    <div class="custom-control custom-radio custom-control-inline">
                                                        <input type="radio" id="profile_verify_yes"
                                                            ...
                                                            value="1" checked>
                                                        <label class="custom-control-label"
                                                            for="profile_verify_yes"><?php echo e(__('yes')); ?></label>
                                                    </div>
                                                    <div class="custom-control custom-radio custom-control-inline">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <label class="form-label"
                                                            ...
                                                            <?php echo e($app_language->name); ?>

                                                            <small class="text-danger">*</small></label>
                                                        <textarea name="description_<?php echo e($app_language->code); ?>" placeholder="<?php echo e(__('enter')); ?> <?php echo e(__('description')); ?>"
                                                            value="<?php echo e(old('description')); ?>" class="form-control <?php if($errors->has($name)): ?> is-invalid <?php endif; ?>"
                                                            id="description_<?php echo e($app_language->code); ?>" cols="1" rows="4"><?php echo e(old('description')); ?></textarea>
...
<?php $__env->startSection('script'); ?>
    <script>
        checkSubscriptionType('<?php echo e(old('subscription_type')); ?>');
        ...
        profileViewLimitation('<?php echo e(old('candidate_cv_view_limitation')); ?>');
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            const debouncedKeyUp = debounce(function() {
                ...
                $.ajax({
                    type: 'POST',
                    url: "<?php echo e(route('module.plan.description.translate')); ?>",
                    data: {
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\wura\Modules/Plan\Resources/views/create.blade.php ENDPATH**/ ?>