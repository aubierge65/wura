...
<?php endif; ?>
                <div class="col-lg-9">
                    <div class="dashboard-right">
                        ...
                        <form action="<?php echo e(route('company.payperjob.store')); ?>" method="POST" class="rt-from">
                            <?php echo csrf_field(); ?>
...
<?php endif; ?>
                                        <select
                                            class="w-100-p select2-taggable select2-search form-control <?php $__errorArgs = ['category_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
<?php endif; ?>
                                        <select
                                            class="w-100-p rt-selectactive select2-taggable form-control <?php $__errorArgs = ['tags'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
<?php endif; ?>
                                        <select
                                            class="w-100-p select2-taggable select2-search form-control <?php $__errorArgs = ['role_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
                                ...
                                <div class="tw-flex tw-gap-5 mb-3">
                                    <div class="tw-flex tw-items-center tw-border ll-radio tw-border-gray-200 tw-rounded">
                                        ...
                                        <label for="salary_rangee"
                                            class="tw-w-full tw-py-4 tw-ms-3 tw-text-sm tw-font-medium"><?php echo e(__('salary_range')); ?></label>
                                    </div>
                                    <div class="tw-flex tw-items-center tw-border ll-radio tw-border-gray-200 tw-rounded">
                                        ...
                                        <label for="custom_salary"
                                            class="tw-w-full tw-py-4 tw-ms-3 tw-text-sm tw-font-medium"><?php echo e(__('custom_salary')); ?></label>
                                    </div>
                                </div>
                                <div class="row">
...
<?php endif; ?>
                                        <div class="position-relative">
                                            <input step="0.01" value="<?php echo e(old('min_salary', '50.00')); ?>"
...
<?php endif; ?>
                                        <div class="position-relative">
                                            <input step="0.01" value="<?php echo e(old('max_salary', '100.00')); ?>"
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="mt-3">
                                    <a onclick="showHideCreateBenefit()" href="javascript:void(0)"
                                        class="text-decoration-underline"><?php echo e(__('create_new')); ?> <?php echo e(__('benefit')); ?></a>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="promote-form-wrapper">
                                <p>
                                    <?php echo e(__('highlight_jobs_or_show_them_on_the_home_page_as_a_feature')); ?>
                                ...
                                <div class="input-wrapper tw-flex tw-flex-wrap tw-gap-6 rt-mb-32">
                                    <label class="form-check promote-form from-radio-custom tw-max-w-[384px]">
                                        ...
                                        <div class="tw-flex tw-items-center tw-ml-6 tw-mt-6">
                                            <input
                                                onclick="promoteJobPrice('<?php echo e($setting->featured_job_price); ?>', '<?php echo e($setting->per_job_price); ?>')"
                                            ...
                                            <label class="form-check-label f-size-14 pointer tw-mt-1"
                                                ...
                                                (+<?php echo e($setting->featured_job_price); ?>)
                                            </label>
                                        </div>
                                    </label>
                                    <label class="form-check promote-form from-radio-custom tw-max-w-[384px]">
                                        ...
                                        <div class="tw-flex tw-items-center tw-ml-6 tw-mt-6">
                                            <input
                                                onclick="promoteJobPrice('<?php echo e($setting->highlight_job_price); ?>', '<?php echo e($setting->per_job_price); ?>')"
                                                value="highlight" class="form-check-input" type="checkbox"
                                                name="badge" id="flexRadioDefault2">
                                            <label class="form-check-label f-size-14 pointer tw-mt-1"
                                                for="flexRadioDefault2">
                                                <?php echo e(__('highlight')); ?> (+<?php echo e($setting->highlight_job_price); ?>)
                                            </label>
                                        </div>
                                    </label>
                            ...
                            <div class="post-job-item rt-mb-15 mt-5">
                                <button type="submit" class="btn btn-primary rt-mr-10">
                                    <span class="button-content-wrapper ">
                                        ...
                                        <span class="button-text">
                                            <?php echo e(__('post_job')); ?> - <span
                                                id="per_job_price"><?php echo e($setting->per_job_price); ?></span>
                                            <?php echo e(currentCurrencyCode()); ?>

                                        </span>
                                        <input type="hidden" id="total_price_perjob" name="total_price_perjob"
                                            value="<?php echo e($setting->per_job_price); ?>">
                                    </span>
                                </button>
                            </div>
                        </form>
    ...
    <input type="text" id="current_rate" value="<?php echo e(getCurrencyRate()); ?>">
<?php $__env->stopSection(); ?>
        ...
        checkboxes.forEach((checkbox) => {
            ...
            checkbox.addEventListener('change', () => {
                ...
                if (!checkbox.checked && checkbox.id === 'flexRadioDefault1') {
                    promoteJobPrice('0', '<?php echo e($setting->per_job_price); ?>')
                } else if (checkbox.checked && checkbox.id === 'flexRadioDefault1') {
                    promoteJobPrice('<?php echo e($setting->featured_job_price); ?>',
                        '<?php echo e($setting->per_job_price); ?>')
                } else if (!checkbox.checked && checkbox.id === 'flexRadioDefault2') {
                    promoteJobPrice('0', '<?php echo e($setting->per_job_price); ?>')
                } else if (checkbox.checked && checkbox.id === 'flexRadioDefault2') {
                    promoteJobPrice('<?php echo e($setting->highlight_job_price); ?>',
                        '<?php echo e($setting->per_job_price); ?>')
                }
            });
        });
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/wura.africa/httpdocs/resources/views/frontend/pages/company/pay-per-job.blade.php ENDPATH**/ ?>