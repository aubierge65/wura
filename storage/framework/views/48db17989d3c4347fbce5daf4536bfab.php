    ...
    <script type="application/ld+json">
{
    ...
    "baseSalary": {
        ...
        "value": {
          ...
          "minValue": <?php echo e($min_salary ?? 0); ?>,
          "maxValue": <?php echo e($max_salary ?? 0); ?>,
                            ...
                            <?php if($job->status == 'pending'): ?>
                                <?php if($job->waiting_for_edit_approval): ?>
                                    <div class="alert bg-warning" role="alert">
                                        <strong>
                                            <?php echo e(__('your_corrections_are_pending_please_wait_for_admin_approved_to_modify_your_changes')); ?>
                                ...
                                <?php else: ?>
                                    <div class="alert bg-warning" role="alert">
                                        <strong>
                                            <?php echo e(__('this_job_is_now_pending_please_wait_for_admin_approval')); ?>
                                            ...
                                            <div class="tw-flex tw-flex-wrap tw-items-center tw-gap-2">
                                                ...
                                                <?php if($job->company): ?>
                                                    <p class="tw-mb-0 tw-whitespace-nowrap tw-text-lg tw-text-[#474C54]">at
                                                        <span><?php echo e($job->company->user->name); ?></span>
                                                    </p>
                                                <?php else: ?>
                                                    <p class="tw-mb-0 tw-whitespace-nowrap tw-text-lg tw-text-[#474C54]">at
...
<?php endif; ?>
                                        ...
                                        <p class="tw-mb-0">
                                            <?php echo e($job->exact_location ? $job->exact_location : $job->full_address); ?></p>
                                    </div>
                                </div>
                            <?php endif; ?>
                        </div>
                ...
                <!-- google adsense area end -->
                    <div class="border border-2 border-primary-50 rt-rounded-12 rt-mb-24 lg:max-536">
                        ...
                        <div class="tw-share-area tw-px-8 tw-pt-6 tw-pb-8">
                            ...
                            <input type="text" class="form-control" value="<?php echo e(url()->current()); ?>" aria-label="Recipient's username" aria-describedby="basic-addon2">
                            <span class="tw-text-primary-500 hover:tw-bg-primary-500 tw-cursor-pointer hover:tw-text-white tw-flex tw-gap-1.5 tw-items-center tw-text-base tw-font-medium tw-bg-[#E7F0FA] tw-px-4 tw-py-2 tw-rounded-[4px]"
                                                                onclick="copyUrl('<?php echo e(url()->current()); ?>')" id="basic-addon2"><?php if (isset($component)) { $__componentOriginalfbfec00c917bef93a2c89d9179a06df5 = $component; } ?>
...
<?php endif; ?></span>
                            ...
                            <ul class="tw-list-none tw-flex tw-flex-wrap tw-items-center tw-gap-2 tw-p-0 tw-m-0 tw-mb-6">
                                <li>
                                    <a href="javascript:void(0);" onclick="openPopUp('<?php echo e(socialMediaShareLinks(url()->current(), 'facebook')); ?>')"
...
<?php endif; ?>
                                ...
                                <li>
                                    <a href="javascript:void(0);" onclick="openPopUp('<?php echo e(socialMediaShareLinks(url()->current(), 'pinterest')); ?>')"
                                        class="tw-inline-flex tw-bg-[#E7F0FA] tw-text-[#0A65CC] hover:tw-bg-[#0A65CC] hover:tw-text-white tw-rounded-[4px] tw-p-2.5">
...
<?php endif; ?>
                                ...
                                <li>
                                    <a href="javascript:void(0);" onclick="openPopUp('<?php echo e(socialMediaShareLinks(url()->current(), 'twitter')); ?>')"
...
<?php endif; ?>
                                ...
                                <li>
                                    <a href="javascript:void(0);" onclick="openPopUp('<?php echo e(socialMediaShareLinks(url()->current(), 'whatsapp')); ?>')"
                                        class="tw-inline-flex tw-bg-[#E7F0FA] tw-text-primary-500 hover:tw-bg-primary-500 hover:tw-text-white tw-rounded-[4px] tw-p-2.5">
...
<?php endif; ?>
                                ...
                                <li>
                                    <a href="javascript:void(0);" onclick="openPopUp('<?php echo e(socialMediaShareLinks(url()->current(), 'linkedin')); ?>')"
                                        class="tw-inline-flex tw-bg-[#E7F0FA] tw-text-primary-500 hover:tw-bg-primary-500 hover:tw-text-white tw-rounded-[4px] tw-p-2.5">
...
<?php endif; ?>
                                ...
                                <li>
                                    <a href="javascript:void(0);" onclick="openPopUp('<?php echo e(socialMediaShareLinks(url()->current(), 'mail')); ?>')"
                                        class="tw-inline-flex tw-bg-[#E7F0FA] tw-text-primary-500 hover:tw-bg-primary-500 hover:tw-text-white tw-rounded-[4px] tw-p-2.5">
...
<?php endif; ?>
                                ...
                                <li>
                                    <a href="javascript:void(0);" onclick="openPopUp('<?php echo e(socialMediaShareLinks(url()->current(), 'telegram')); ?>')"
                                        class="tw-inline-flex tw-bg-[#E7F0FA] tw-text-primary-500 hover:tw-bg-primary-500 hover:tw-text-white tw-rounded-[4px] tw-p-2.5">
...
<?php endif; ?>
                                ...
                                <li>
                                    <a href="javascript:void(0);" onclick="openPopUp('<?php echo e(socialMediaShareLinks(url()->current(), 'skype')); ?>')"
                                        class="tw-inline-flex tw-bg-[#E7F0FA] tw-text-primary-500 hover:tw-bg-primary-500 hover:tw-text-white tw-rounded-[4px] tw-p-2.5">
...
unset($__errorArgs, $__bag); ?>" name="cover_letter"
                                rows="7"><?php echo e(old('cover_letter')); ?></textarea>
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/wura.africa/httpdocs/resources/views/frontend/pages/job-details.blade.php ENDPATH**/ ?>