    ...
    <div class="container">
        <div class="breadcrumb-menu">
            ...
            <ul>
                ...
                <li>/</li>
                <li><?php echo e(__('privacy_policy')); ?></li>
            </ul>
        </div>
    </div>
</div>
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/MEGATECH/wura1/resources/views/frontend/pages/privacy-policy.blade.php ENDPATH**/ ?>