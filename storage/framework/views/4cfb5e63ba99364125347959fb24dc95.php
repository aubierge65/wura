    ...
    <div class="wrapper">
        ...
        <nav id="nav"
            ...
            <ul class="navbar-nav ml-auto">
                <?php echo $__env->make('backend.layouts.partials.top-right-nav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            </ul>
        </nav>

        <!-- Support Menu -->
        <?php if(!config('app.hide_helper')): ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.help-widget','data' => []] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
        ...
        <?php if(request()->is('admin/settings/*')): ?>
            <?php echo $__env->make('backend.layouts.partials.setting-sidebar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <?php else: ?>
            <?php echo $__env->make('backend.layouts.partials.default-sidebar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <?php endif; ?>
...
<?php /**PATH /var/www/vhosts/wura.africa/httpdocs/resources/views/backend/layouts/left-nav.blade.php ENDPATH**/ ?>