        ...
        <div class="ll-invoice-in">
            ...
            <div class="ll-invoice-info">
                ...
                <div class="ll-invoice-info_right">
                    <div><span class="span-1">Invoice No:</span> <b>#<?php echo e($transaction->order_id); ?></b></div>
                    <div style="width:40%;"><span class="span-1">Date:</span> <b><?php echo e(formatTime($transaction->created_at, 'M d, Y')); ?></b></div>
                </div>
            ...
            <div class="ll-invoice-table-wrap">
                    ...
                    <table>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="w-32">
                                    <span>Job Limit : <?php echo e($transaction->plan->job_limit); ?></span> <br>
                                    <span>Featured Job Limit : <?php echo e($transaction->plan->featured_job_limit); ?></span> <br>
                                    <span>Highlight Job Limit : <?php echo e($transaction->plan->highlight_job_limit); ?></span> <br>
                                    <span>Candidate CV View Limit : <?php echo e($transaction->plan->candidate_cv_view_limitation == 'limited' ? $transaction->plan->candidate_cv_view_limit: __('unlimited')); ?></span>
                                    <br>
                                </td>
                                <?php endif; ?>
                ...
                <div class="ll-invoice-footer-table">
                    <div class="left-side">
                        ...
                        <p>Payment Method - <?php echo e(ucfirst($transaction->payment_provider)); ?>

                        <p>Payment Type - <?php echo e(str_replace('_', ' ', ucfirst($transaction->payment_type))); ?>

                        <br>Payment Status: <?php echo e(ucfirst($transaction->payment_status)); ?>

                        <br>Amount:  <?php echo e($amount); ?>
...
<?php /**PATH /var/www/vhosts/wura.africa/httpdocs/resources/views/frontend/pages/invoice/preview-invoice.blade.php ENDPATH**/ ?>