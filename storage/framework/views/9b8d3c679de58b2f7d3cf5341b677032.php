...
<?php echo e(__('edit')); ?> <?php echo e(strtolower(__('post'))); ?>
...
<?php endif; ?>
                <div class="col-md-9">
                    ...
                    <form action="<?php echo e(route('company.blog.update', $post)); ?>" method = 'POST'  enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                                    ...
                                    <div class="col-md-2">
                                        <div class="custom-control custom-radio mr-3">
                                            <input class="custom-control-input" type="radio"
                                                ...
                                                <?php echo e($lang->code == $post->locale ? 'checked' : ''); ?>
...
$message = $__bag->first($__errorArgs[0]); ?>
                                    <span
                                        class="text-danger font-size-13 d-block"><strong><?php echo e($message); ?></strong></span>
                                <?php unset($message);
                        ...
                        <div class="row mt-3">
                            <div class="col-md-8">
                                <div class="form-group">
                                    ...
                                    <input value="<?php echo e($post->title); ?>" name="title" type="text"
...
unset($__errorArgs, $__bag); ?> ">
                                        ...
                                        <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option <?php echo e($post->category_id == $category->id ? 'selected' : ''); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group mt-3">
                            ...
                            <textarea rows="5" type="text" class="form-control height-124px" name="short_description"
                                placeholder="<?php echo e(__('enter')); ?> <?php echo e(__('short_description')); ?>"><?php echo e($post->short_description); ?></textarea>
...
$message = $__bag->first($__errorArgs[0]); ?>
                                <span
                                    class="text-danger font-size-13"><strong><?php echo e($message); ?></strong></span>
                            <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group mt-3">
                            ...
                            <textarea id="image_ckeditor" type="text" class="form-control" name="description"
                                placeholder="<?php echo e(__('enter')); ?>  <?php echo e(__('description')); ?>"><?php echo e($post->description); ?></textarea>
                        ...
                        <div class="form-group" style="position: relative;">
                            ...
                            <div class="upload-btn-wrapper">
                                <input type="file" class="form-control dropify"
                                    data-default-file="<?php echo e($post->image_url); ?>" name="image"
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/wura.africa/httpdocs/resources/views/frontend/pages/company/blog/edit.blade.php ENDPATH**/ ?>