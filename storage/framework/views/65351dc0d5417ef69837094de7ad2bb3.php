                    ...
                    <div class="row pt-3 pb-3">
                        <div class="col-6 offset-md-3 text-center">
                            <?php if($testimonial->image): ?>
                                <img class="rounded m-auto p-3 border" id="image" width="150px" height="150px" src=" <?php echo e(asset($testimonial->image)); ?>" alt="user image">
                            <?php else: ?>
                    ...
                    <div class="row pt-3 pb-4">
                        <div class="col-md-6 offset-md-3">
                            <form class="form-horizontal"
                                action="<?php echo e(route('module.testimonial.update', $testimonial->id)); ?>" method="POST"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input value="<?php echo e($testimonial->name); ?>" name="name" type="text"
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-3 col-form-label"><?php echo e(__('position')); ?><small
                                            class="text-danger">*</small></label>
                                    <div class="col-sm-9">
                                        <input value="<?php echo e($testimonial->position); ?>" name="position" type="text"
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <div id="rateYo"></div>
                                        <input value="<?php echo e($testimonial->stars); ?>" type="hidden" name="stars" id="rating"
                                    ...
                                    <div class="col-sm-9 d-flex">
                                        <?php $__currentLoopData = $app_languages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lang): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="custom-control custom-radio mr-3">
                                                <input class="custom-control-input" type="radio" id="lang_code_<?php echo e($lang->id); ?>" name="code" <?php echo e($lang->code == $testimonial->code ? 'checked':''); ?> value="<?php echo e($lang->code); ?>">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <textarea rows="8" type="text" class="form-control" name="description"
                                            placeholder="<?php echo e(__('description')); ?>... "><?php echo e($testimonial->description); ?></textarea>
...
<?php $__env->startSection('script'); ?>
    ...
    <script>
        $("#rateYo").rateYo({
            ...
            mormalFill: 'yellow',
            ratedFill: '#ffc107',
            rating: <?php echo e($testimonial->stars); ?>,
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/MEGATECH/wura1/Modules/Testimonial/Resources/views/edit.blade.php ENDPATH**/ ?>