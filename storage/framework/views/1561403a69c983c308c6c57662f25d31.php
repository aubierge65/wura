                        ...
                        <div class="candidate-profile mb-4 mb-md-0">
                            <div class="candidate-profile-img">
                                <img id="candidate_image"
                                    src="<?php echo e(asset('frontend')); ?>/assets/images/all-img/candidate-profile.png"
                                    alt="profile">
                            </div>
                            <div class="candidate-profile-info">
                                <h2 class="name"></h2>
                                <h4 class="designation"></h4>
                                <h6 class="availablity d-none"><?php echo e(__('i_am_available')); ?></h6>
                            </div>
                        </div>
                    </div>
                                ...
                                <button id="bookmakCandidate"
                                    ...
                                    <svg width="16" height="20" viewBox="0 0 16 20" fill="none"
                                        ...
                                        <path
                                            ...
                                            stroke="<?php echo e($setting->frontend_primary_color); ?>" stroke-width="1.5"
                ...
                <div class="row">
                    <div class="col-lg-8">
                        <ul class="nav nav-tabs tw-gap-x-6 !tw-border-b !tw-border-[#E3E5E6]" id="myTab"
                            ...
                            <li class="nav-item" role="presentation">
                                <button class="ll-nav-link nav-link" id="profile-tab" data-bs-toggle="tab" ata-bs-target="#profile" type="button" role="tab" aria-controls="profile" ria-selected="false"> <?php echo e(__('about_me')); ?> </button>
                            </li>
                        </ul>
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                                <div class="tw-py-6">
                                    <h4 class="tw-text-lg tw-font-medium tw-leading-[100%] tw-text-[#18191C]"> <?php echo e(__('biography')); ?> </h4>
                                    <p class="tw-text-base tw-text-[#5E6670]" id="candidate-bio"> </p>
                                    <h4 class="tw-text-lg tw-font-medium tw-leading-[100%] tw-text-[#18191C] tw-mb-4"> <?php echo e(__('experience')); ?> </h4>
                                    ...
                                    <h4 class="tw-text-lg tw-font-medium tw-leading-[100%] tw-text-[#18191C] tw-mb-4"> <?php echo e(__('education')); ?> </h4>
                                ...
                                <div class="social-links">
                                    <h2 class="title"> <?php echo e(__('follow_me_social_media')); ?> </h2>
                    ...
                    <div class="col-lg-4">
                        <div class="sidebar-widget">
                            <div class="row">
                                <div class="col-md-12">
                                    <h2 class="title"><?php echo e(__('skills')); ?></h2>
                                    <div class="tw-flex tw-flex-wrap tw-gap-2 tw-mb-6" id="candidate_skills"></div>
                                </div>
                                <div class="col-md-12">
                                    <h2 class="title"><?php echo e(__('languages')); ?></h2>
...
<?php endif; ?>
                                        ...
                                        <h3 class="sub-title text-uppercase"><?php echo e(__('date_of_birth')); ?></h3>
...
<?php endif; ?>
                                        ...
                                        <h3 class="sub-title"><?php echo e(__('country')); ?></h3>
...
<?php endif; ?>
                                        ...
                                        <h3 class="sub-title"><?php echo e(__('marital_status')); ?></h3>
                                ...
                                <div class="col-md-6">
                                    <div class="icon-box">
                                        <div class="icon-img">
                                            <?php if (isset($component)) { $__componentOriginal7a966e0fcc4cccc677b61980aa627a25 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal7a966e0fcc4cccc677b61980aa627a25 = $attributes; } ?>
<?php $component = App\View\Components\Svg\Gender::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('svg.gender'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(App\View\Components\Svg\Gender::class))->getConstructor()): ?>
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes([]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal7a966e0fcc4cccc677b61980aa627a25)): ?>
<?php $attributes = $__attributesOriginal7a966e0fcc4cccc677b61980aa627a25; ?>
<?php unset($__attributesOriginal7a966e0fcc4cccc677b61980aa627a25); ?>
<?php endif; ?>
<?php if (isset($__componentOriginal7a966e0fcc4cccc677b61980aa627a25)): ?>
<?php $component = $__componentOriginal7a966e0fcc4cccc677b61980aa627a25; ?>
<?php unset($__componentOriginal7a966e0fcc4cccc677b61980aa627a25); ?>
<?php endif; ?>
                                        </div>
                                        <h3 class="sub-title"><?php echo e(__('gender')); ?></h3>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="icon-box">
                                        ...
                                        <h3 class="sub-title"><?php echo e(__('experience')); ?></h3>
                                ...
                                <div class="col-md-6">
                                    <div class="icon-box">
                                        <div class="icon-img">
                                            <?php if (isset($component)) { $__componentOriginaldb189bf8bf5afa5f86c996b4e559e17d = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginaldb189bf8bf5afa5f86c996b4e559e17d = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.svg.education-cap-icon','data' => []] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('svg.education-cap-icon'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
...
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginaldb189bf8bf5afa5f86c996b4e559e17d)): ?>
<?php $attributes = $__attributesOriginaldb189bf8bf5afa5f86c996b4e559e17d; ?>
<?php unset($__attributesOriginaldb189bf8bf5afa5f86c996b4e559e17d); ?>
<?php endif; ?>
<?php if (isset($__componentOriginaldb189bf8bf5afa5f86c996b4e559e17d)): ?>
<?php $component = $__componentOriginaldb189bf8bf5afa5f86c996b4e559e17d; ?>
<?php unset($__componentOriginaldb189bf8bf5afa5f86c996b4e559e17d); ?>
<?php endif; ?>
                                        </div>
                                        <h3 class="sub-title"><?php echo e(__('education')); ?></h3>
                        ...
                        <div class="sidebar-widget">
                            <div class="contact">
                                <h2 class="title"><?php echo e(__('contact_information')); ?></h2>
...
<?php endif; ?>
                                    ...
                                    <div class="info">
                                        ...
                                        <h3 class="subtitle"><?php echo e(__('secondary_phone')); ?></h3>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.svg.envelope-icon','data' => ['width' => '32','height' => '32']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['width' => '32','height' => '32']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
        ...
        <div class="modal-content tw-w-[648px]">
            <div class="chat-top tw-rounded-tl-xl tw-rounded-tr-xl tw-p-6 tw-bg-[#F1F2F4]">
                <h2 class="tw-text-base tw-font-semibold tw-text-[#18191C] tw-mt-0 tw-mb-3">
                    <?php echo e(__('message_candidate')); ?></h2>
                <div class="tw-flex tw-gap-3 tw-mb-3 tw-items-center">
                    <img class="tw-w-[48px] tw-h-[48px] tw-rounded-full tw-object-cover" src="<?php echo e(asset('frontend')); ?>/assets/images/all-img/candidate-profile.png"
            ...
            <div class="chat-bottom tw-p-6 tw-bg-white tw-rounded-bl-xl tw-rounded-br-xl">
                <form action="<?php echo e(route('company.message.candidate')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="form-group">
                        <label for="chat"
                            class="tw-text-sm tw-text-[#18191C] tw-mb-2"><?php echo e(__('your_message')); ?></label>
                        <textarea required id="chat" placeholder="<?php echo e(__('write_your_message')); ?>"
                    ...
                    <div class="tw-mt-6 tw-flex tw-justify-between tw-items-center">
                        ...
                        <button type="button"
                            class="btn tw-py-[11px] tw-px-[23px] tw-text-base tw-capitalize tw-font-semibold tw-text-[#474C54] tw-border tw-border-[#E4E5E8]"><?php echo e(__('cancel')); ?></button>
                        <button type="submit"
                            ...
                            <span><?php echo e(__('send_message')); ?></span>
                        </button>
                    </div>
                </form>
            </div>
...
<?php /**PATH /var/www/vhosts/wura.africa/httpdocs/resources/views/components/website/modal/candidate-profile-modal.blade.php ENDPATH**/ ?>