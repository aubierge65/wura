        ...
        <div class="container">
            <div class="row align-items-center breadcrumbs-height">
                <div class="col-12 justify-content-center text-center">
                    <div class="breadcrumb-title rt-mb-10"> <?php echo e(__('privacy_policy')); ?></div>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb justify-content-center">
                            <li class="breadcrumb-item"><a href="<?php echo e(route('website.home')); ?>"><?php echo e(__('home')); ?></a></li>
                            <li class="breadcrumb-item active" aria-current="page"> <?php echo e(__('privacy_policy')); ?></li>
                        </ol>
                    </nav>
                </div>
            </div>
                ...
                <div class=" col-lg-12 order-1 order-lg-0 rt-mb-lg-20">
                    <div>
                        ...
                        <div class="privacy-page body-font-3 text-gray-500 rt-mb-24">
                            <?php echo $privacy_page == null ? $privacy_page_default->privary_page : $privacy_page; ?>
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/wura.africa/httpdocs/resources/views/frontend/pages/privacy-policy.blade.php ENDPATH**/ ?>