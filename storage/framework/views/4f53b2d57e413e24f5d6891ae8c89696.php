...
<?php $component = App\View\Components\Website\Company\NotificationsComponent::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('website.company.notifications-component'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(App\View\Components\Website\Company\NotificationsComponent::class))->getConstructor()): ?>
...
<?php $component = App\View\Components\Website\Candidate\NotificationsComponent::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('website.candidate.notifications-component'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(App\View\Components\Website\Candidate\NotificationsComponent::class))->getConstructor()): ?>
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes([]); ?>
<?php echo $__env->renderComponent(); ?>
...
<?php $component = App\View\Components\Svg\Telephone2Icon::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('svg.telephone2-icon'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(App\View\Components\Svg\Telephone2Icon::class))->getConstructor()): ?>
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes([]); ?>
<?php echo $__env->renderComponent(); ?>
...
<?php endif; ?>
                        ...
                        <?php if(count($headerCurrencies) && $setting->currency_switcher): ?>
                            ...
                            <div class="dropdown xs:tw-inline-flex tw-hidden">
                                <button class="btn <?php echo e(count($headerCurrencies) ? 'dropdown-toggle' : ''); ?>"
                                    type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown"
                                    aria-expanded="false">
                                    <?php echo e($current_currency_code); ?>
                            ...
                            <div class="togglesearch">
                                <form action="<?php echo e(route('website.job')); ?>" method="GET" id="search-form"
                                    ...
                                    <div class="search-box form-item position-relative">
                                        ...
                                        <input name="keyword" class="search-input w-100" type="text"
                                            placeholder="<?php echo e(__('job_title_keyword')); ?>"
                                            value="<?php echo e(request('keyword')); ?>" id="search_input">
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.website.company.message-component','data' => []] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
                                ...
                                <ul class="list-unstyled tw-flex tw-flex-wrap tw-gap-3 tw-items-center tw-justify-between">
                                    <li>
                                        <a href="<?php echo e(route('login')); ?>"
                                            class="btn btn-outline-light"><?php echo e(__('sign_in')); ?></a>
                                    </li>
                                    <li class="d-none d-sm-block">
                                        <a href="<?php echo e(route('company.job.create')); ?>"
                                            class="btn btn-light"><?php echo e(__('post_job')); ?>
...
<?php $__env->stopPush(); ?>
<?php /**PATH /var/www/vhosts/wura.africa/httpdocs/resources/views/frontend/partials/header.blade.php ENDPATH**/ ?>