        ...
        <div class="ll-invoice-in">
            ...
            <div class="ll-invoice-info">
                ...
                <div class="ll-invoice-info_right">
                    <div><span>Invoice No:</span> <b>#<?php echo e($transaction->order_id); ?></b></div>
                    <div style="width: 40%;"><span>Date:</span>
                        <b><?php echo e(formatTime($transaction->created_at, 'M d, Y')); ?></b></div>
                </div>
                            ...
                            <tr>
                                ...
                                <?php if($transaction->payment_type != 'per_job_based'): ?>
                                    <td>
                                        ...
                                        <span>Featured Job Limit : <?php echo e($transaction->plan->featured_job_limit); ?></span>
                                        <br>
                                        <span>Highlight Job Limit :
                                            <?php echo e($transaction->plan->highlight_job_limit); ?></span> <br>
                                        <span>Candidate CV View Limit :
                                            <?php echo e($transaction->plan->candidate_cv_view_limitation == 'limited' ? $transaction->plan->candidate_cv_view_limit : __('unlimited')); ?></span>
                                        <br>
                                    </td>
                                <?php endif; ?>
            ...
            <div style="position: absolute; bottom: 30px; left:50px; right: 50px; text-align: center;">
                ...
                <a href="<?php echo e(route('website.termsCondition')); ?>" target="_blank" rel="noopener noreferrer">View Terms &
                    Condition</a>
            </div>
        </div>
    </div>
...
<?php /**PATH C:\wamp64\www\wura\resources\views/frontend/pages/invoice/download-invoice.blade.php ENDPATH**/ ?>