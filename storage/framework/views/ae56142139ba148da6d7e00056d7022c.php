...
<?php $component = App\View\Components\Forms\Label::resolve(['name' => 'banner_image','class' => 'pointer body-font-4 d-block text-gray-900 rt-mb-8'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
    <div id="banner-uploadMode" class="<?php echo e($user->company->banner ? 'd-none' : ''); ?>">
    ...
    <div  id="banner-oldMode" class="<?php echo e($user->company->banner ? '' : 'd-none'); ?> banner-file-upload-content2">
        <img class="banner-file-upload-image" src="<?php echo e($user->company->banner_url); ?>"
            alt="your image" />
...
<?php /**PATH /var/www/vhosts/wura.africa/httpdocs/resources/views/components/website/company/banner-section.blade.php ENDPATH**/ ?>