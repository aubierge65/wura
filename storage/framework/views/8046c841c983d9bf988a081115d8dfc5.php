<?php $__env->startSection('title', __('bookmarks')); ?>
                ...
                <div class="col-lg-9">
                    <div class="dashboard-right tw-ps-0 lg:tw-ps-3">
                        <div class="row d-flex tw-flex-wrap justify-content-between p-2">
                            <div class="col-sm-12 col-md-6">
                                <h3 class="f-size-18 lh-1 mb-2 p-2">
                                    <?php echo e(__('bookmarks')); ?>

                                    <span class="text-gray-400">(<?php echo e($bookmarks->total()); ?>)</span>
                                </h3>
                            </div>
                            <div class="col-sm-12 col-md-6 d-flex tw-flex-wrap tw-gap-3 tw-justify-between">
                                <form id="categoryForm" action="<?php echo e(route('company.bookmark')); ?>" method="GET">
                                    <div class="header-dropdown d-flex tw-flex-wrap">
                                        ...
                                        <select onchange="CategoryForm()" name="category" class="rt-selectactive ">
                                            ...
                                            <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option <?php echo e(Route::current()->parameter('category') == $cat->id ? 'selected' : ''); ?>
                        ...
                        <?php if($bookmarks->count() > 0): ?>
                            <?php $__currentLoopData = $bookmarks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $candidate): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <div class="card-body">
                                        <div class="rt-single-icon-box tw-flex-wrap">
                                            <div class="icon-thumb">
                                                <div class="profile-image position-relative">
                                                    <a href="javascript:void(0)"
                                                        onclick="showCandidateProfileModal('<?php echo e($candidate->user->username); ?>')">
                                            ...
                                            <div class="iconbox-content">
                                                <div class="post-info2">
                                                    ...
                                                    <span class="loacton text-gray-400 ">
                                                        <?php if($candidate->profession): ?>
                                                            <?php echo e(ucfirst($candidate->profession->name)); ?>
                                            ...
                                            <div class="iconbox-extra align-self-center">
                                                <div>
                                                    <form
                                                        action="<?php echo e(route('company.companybookmarkcandidate', $candidate->id)); ?>"
                                                        method="POST">
                                                        <?php echo csrf_field(); ?>
                                                        <button type="submit"
                                                            class="text-primary-500 hoverbg-primary-50 plain-button icon-button">
                                                            <?php if (isset($component)) { $__componentOriginalbcf040260d3a1ec078c1add968960d45 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalbcf040260d3a1ec078c1add968960d45 = $attributes; } ?>
<?php $component = App\View\Components\Svg\Bookmark2Icon::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('svg.bookmark2-icon'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(App\View\Components\Svg\Bookmark2Icon::class))->getConstructor()): ?>
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes([]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalbcf040260d3a1ec078c1add968960d45)): ?>
<?php $attributes = $__attributesOriginalbcf040260d3a1ec078c1add968960d45; ?>
<?php unset($__attributesOriginalbcf040260d3a1ec078c1add968960d45); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalbcf040260d3a1ec078c1add968960d45)): ?>
<?php $component = $__componentOriginalbcf040260d3a1ec078c1add968960d45; ?>
<?php unset($__componentOriginalbcf040260d3a1ec078c1add968960d45); ?>
<?php endif; ?>
                                                        </button>
                                                    </form>
                                                </div>
                                                <div>
                                                    ...
                                                    <?php else: ?>
                                                        ...
                                                        <a onclick="toastr.warning('<?php echo e(__('your_account_is_not_active_please_wait_until_the_account_is_activated_by_admin')); ?>')"
                                                            class="btn btn-primary2-50" href="javascript:void(0)">
                                                            <span class="button-content-wrapper ">
                                                                <span class="button-icon align-icon-right">
                                                                    <i class="ph-arrow-right"></i>
                                                    ...
                                                    <ul class="dropdown-menu dropdown-menu-end company-dashboard-dropdown"
                                                        ...
                                                        <li>
                                                            <a target="__blank" class="dropdown-item"
                                                                href="mailto:<?php echo e($candidate->user->email); ?>">
...
<?php endif; ?>
                    ...
                    <?php if($bookmarks->total() > $bookmarks->count()): ?>
                        <nav>
                            <?php echo e($bookmarks->links('vendor.pagination.frontend')); ?>
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/wura.africa/httpdocs/resources/views/frontend/pages/company/bookmark.blade.php ENDPATH**/ ?>