...
<?php $__env->startSection('content'); ?>
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title line-height-36"><?php echo e(__('benefit_list')); ?>

                            (<?php echo e(count($benefits)); ?>)</h3>
                    </div>
                        ...
                        <table class="table table-hover text-nowrap">
                            <thead>
                                <tr>
                                    ...
                                    <?php if(userCan('benefits.update') || userCan('benefits.delete')): ?>
                                        <th width="10%"><?php echo e(__('action')); ?></th>
                                    <?php endif; ?>
                                </tr>
                            </thead>
                            <tbody>
                                <?php $__empty_1 = true; $__currentLoopData = $benefits; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr>
                                        <td>
                                        ...
                                        <td>
                                            <?php if(userCan('benefits.update')): ?>
                                                <a href="<?php echo e(route('benefit.edit', $item->id)); ?>" class="btn bg-info"><i
                                                        class="fas fa-edit"></i></a>
                                            <?php endif; ?>
                                            <?php if(userCan('benefits.delete')): ?>
                                                <form action="<?php echo e(route('benefit.destroy', $item->id)); ?>" method="POST"
                                                    class="d-inline">
            ...
            <div class="col-md-4">
                <?php if(!empty($benefit) && userCan('benefits.update')): ?>
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title line-height-36"><?php echo e(__('edit')); ?> <?php echo e('benefit'); ?></h3>
                            <a href="<?php echo e(route('benefit.index')); ?>"
                        ...
                        <div class="card-body">
                            <div class="pt-3 pb-4">
                                <form class="form-horizontal" action="<?php echo e(route('benefit.update', $benefit->id)); ?>"
                                    method="POST">
                                    <?php echo csrf_field(); ?>
...
<?php endif; ?>
                ...
                <?php endif; ?>
                <?php if(empty($benefit) && userCan('benefits.create')): ?>
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title line-height-36"><?php echo e(__('create')); ?> <?php echo e('benefit'); ?></h3>
                        </div>
                        <div class="card-body">
                            <?php if(userCan('benefits.create')): ?>
                                <form class="form-horizontal" action="<?php echo e(route('benefit.store')); ?>" method="POST">
                                    <?php echo csrf_field(); ?>
                                    <?php $__currentLoopData = $app_language; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $language): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php
                                            $label = __('name') . ' ' . getLanguageByCodeInLookUp($language->code,$app_language);
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/wura.africa/httpdocs/resources/views/backend/benefit/index.blade.php ENDPATH**/ ?>